...
import com.example.appoperaciones.Adaptadores.RecyclerBloqueos;
 ...
 * Use the {@link ConsultaBloqueosFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ConsultaBloqueosFragment extends Fragment {
    ...
    public ConsultaBloqueosFragment() {
     ...
     * @return A new instance of fragment ConsultaBloqueosFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ConsultaBloqueosFragment newInstance(String param1, String param2) {
        ConsultaBloqueosFragment fragment = new ConsultaBloqueosFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_consulta_bloqueos, container, false);
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if(!spinner_tiendas.getSelectedItem().toString().equals("Seleccionar")){
                        String resp = new ConsultarBloqueosTienda(getContext()).execute(value_fecha, String.valueOf(idtienda)).get();
                        if(isJSONArrayValid(resp)){
                            ...
                            if(nueva_lista.size() > 0){
                                RecyclerBloqueos recyclerBloqueos= new RecyclerBloqueos(nueva_lista,getContext(),idtienda,value_fecha);
                                recyclerView.setAdapter(recyclerBloqueos);
                            }else{
