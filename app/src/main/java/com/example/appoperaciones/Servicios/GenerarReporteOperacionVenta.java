...
public class GenerarReporteOperacionVenta extends AsyncTask<String, Void, String> {


    Context context;
    private ReportesOperacionActivity.AsyncTaskListener asyncTaskListener;
    public GenerarReporteOperacionVenta(Context context)
    {
    ...
    protected String doInBackground(String... parametros) {
        String result = "";
        String connstr = "https://www.tiendapizzaamericana.co/ProyectoPizzaAmericana/GenerarReporteOperacionVenta";
