...
public class ObtenerResultadoEncuestaOperacionDet extends AsyncTask<String, Void, String> {

    Context context;
    public ObtenerResultadoEncuestaOperacionDet(Context context)
    {
    ...
    protected String doInBackground(String... parametros) {
        String result = "";
        String idempleadoencuesta  =parametros[0];
        String connstr = "https://www.tiendapizzaamericana.co/ProyectoPizzaAmericana/ObtenerResultadoEncuestaOperacionDet";
        ...
        try {
            ...
            String data = URLEncoder.encode("idempleadoencuesta","UTF-8")+"="+URLEncoder.encode(idempleadoencuesta,"UTF-8");
            writer.write(data);
            writer.flush();
            writer.close();
            ops.close();
